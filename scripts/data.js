...
const PhiH_Quotes = {
    "quotes": [
        {
            "id": "quote1",
            "ar": {
                "text": "\"إن الذين حافظوا على العقيدة القديمة خشوا من أن يكونوا قد بقوا وحدهم أوفياء لها، وما داموا يخشون العزلة أكثر من خشيتهم الخطأ، فإنّهم قد التحقوا بالحشد دون التفكير على شاكلته. وما لم يكن غير إحساس جزء من الأمة بدا كما لو كان رأي الجميع ولاح من ثمّة قاهرا حتّى بالنسبة إلى أولئك الذين أضفوا عليه ذلك المظهر الزائف.\"",
                "author": "ألكسيس دي توكفيل",
                "source": "النظام القديم والثورة"
			},
            "fr": {
                "text": "\"Ceux qui ont maintenu l'ancienne croyance craignaient d'être restés seuls fidèles à elle, et tant qu'ils craignaient la solitude plus qu'ils ne craignaient l'erreur, ils ont rejoint la foule sans penser à leur manière. Et ce n'était qu'un sentiment d'une partie de la nation qui semblait être l'opinion de tous et apparaissait alors comme contraignant même pour ceux qui lui avaient donné cette apparence trompeuse.\"",
                "author": "Alexis de Tocqueville",
                "source": "L'Ancien Régime et la Révolution"
			},
            "en": {
                "text": "\"Those who maintained the old belief feared that they had remained alone faithful to it, and as long as they feared solitude more than they feared error, they joined the crowd without thinking in their own way. And it was only a feeling of a part of the nation that seemed to be the opinion of all and appeared then as binding even for those who had given it that deceptive appearance.\"",
                "author": "Alexis de Tocqueville",
		...
		},
        {
            "id": "quote2",
            "ar": {
                "text": "\"إن أعظم عقاب بالنسبة إليّ هو أن أكون وحيدا في الجنّة\"",
                "author": "غوته",
                "source": "خواطر"
			},
            "fr": {
                "text": "\"Le plus grand châtiment pour moi serait d'être seul au paradis\"",
                "author": "Goethe",
                "source": "Pensées"
			},
            "en": {
                "text": "\"The greatest punishment for me would be to be alone in paradise\"",
                "author": "Goethe",
                "source": "Thoughts"
			}
		},
        {
            "id": "quote3",
            "ar": {
                "text": "\"في العزلة يضني المعتزل قلبه بنفسه، ومع الجماعة فإنّ الحشد هو ما يضنيه\"",
                "author": "نيتشه",
                "source": "إنساني مفرط في الإنسانية"
			},
            "fr": {
                "text": "\"Dans la solitude, le solitaire consume son cœur par lui-même, et avec la communauté, c'est la foule qui le consume\"",
                "author": "Nietzsche",
                "source": "Humain, trop humain"
			},
            "en": {
                "text": "\"In solitude, the solitary consumes his heart by himself, and with the community, it is the crowd that consumes him\"",
                "author": "Nietzsche",
    ...
    "section_title": {
        ...
        "fr": "Citations et textes connexes",
        "en": "Related Quotes and Texts"
	}
};